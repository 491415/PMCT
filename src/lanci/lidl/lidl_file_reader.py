...
from src.lanci.lidl.lidl_utils import extract_address_city
    ...
    if file_path.is_file():
        ...
        try:
            ...
            dat_dto = DatotekaDTO(
                ...
                pmpo_id=pmpo_id,
                dat_naziv=file_name,
                dat_naziv_zip=f"Popis_cijena_po_trgovinama_na_dan_{datum_cijena.split('.')[0]}_{datum_cijena.split('.')[1]}_{datum_cijena.split('.')[2]}",
