...
from src.lanci.plodine.plodine_utils import extract_address_city
    ...
    if file_path.is_file():
        ...
        try:
            ...
            dat_dto = DatotekaDTO(
                ...
                pmpo_id=pmpo_id,
                dat_naziv=file_name,
                dat_naziv_zip=f"cjenici_{datum_cijena.split('.')[0]}_{datum_cijena.split('.')[1]}_{datum_cijena.split('.')[2]}_07_00_01",
